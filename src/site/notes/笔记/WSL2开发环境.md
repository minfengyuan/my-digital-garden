---
{"dg-publish":true,"title":"WSL2开发环境","created":"2024/01/16, 15:17","updated":"2024/01/16, 15:18","tags":["ubuntu","cuda"],"permalink":"/笔记/WSL2开发环境/","dgPassFrontmatter":true}
---
...
具体实现过程参考 [[笔记/Ubuntu系统安装和初始化\|Ubuntu系统安装和初始化]] 部分。

# 安装远程桌面环境

具体实现过程参考 [[笔记/Linux实现远程桌面环境\|Linux实现远程桌面环境]]。
